...
def main(args_eval, resume_preempt=False):
    ...
    tfms = EvalVideoTransform(num_views_per_clip=eval_num_segments)
    # # -- optimizer and scheduler
    val_dataset = FramesDataset('../data/spotting-ball-2024/train', transforms=tfms)
    val_loader = DataLoader(val_dataset, batch_size=64)

    train_dataset = FramesDataset('../data/spotting-ball-2024/valid', transforms=tfms)
