...
def plot_guess_img(input_tensor, output_filename, reference_img='evals/video_classification_frozen/reference_with_border.png', scale=1000):
    ...
    plt.savefig(os.path.join('plots/', output_filename), bbox_inches='tight', pad_inches=0)
    plt.close()
