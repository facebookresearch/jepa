...
def plot_guess_img(input_tensor, reference_img='/scratch/ki2130/my-jepa/jepa/evals/video_classification_frozen/reference_with_border.png', output_filename='guess.png', scale=150):
