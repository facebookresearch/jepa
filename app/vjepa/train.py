...
from src.utils.logging import CSVLogger, gpu_timer, get_logger, grad_logger, adamw_logger, AverageMeter
...
def main(args, resume_preempt=False):
    ...
    wandb.init(project="vjepa", name="vjepa_excavator_pretraining")
                    ...
                    wandb.log(
                        {
                            ...
                            "iteration": itr,
                            "loss": loss_meter.avg,
                            "loss-jepa": jepa_loss_meter.avg,
                            "reg-loss": reg_loss_meter.avg,
                            "grad-enc": grad_stats.global_norm,
                            "grad-pred": grad_stats_pred.global_norm,
                            "input-var": input_var_meter.avg,
                            "input-var-min": input_var_min_meter.avg,
                            "gpu-mem": torch.cuda.max_memory_allocated() / 1024.0**2,
                            "gpu-time": gpu_time_meter.avg,
                            "wall-time": wall_time_meter.avg,
                        }
                    )
