...
def process_main(rank, fname, world_size, devices):
    ...
    # Update this line to load your new train_with_actions module:
    train_module = importlib.import_module(f"app.{params['app']}.train_with_actions")

    # Launch the app with loaded config (use the imported train_module):
    train_module.main(args=params)
